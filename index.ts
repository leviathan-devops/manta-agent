...
export default async function MantaAgent(input: PluginInput): Promise<Hooks> {
  ...
  return {
    ...
    config: async (cfg: Record<string, unknown>) => {
      ...
      agent['manta'] = {
        name: ac.orchestrator.name, description: ac.orchestrator.description,
